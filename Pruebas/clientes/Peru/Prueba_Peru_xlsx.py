...
def procesar():
    ...
    rutas = {
        "remittance": os.path.join(root,"Archivos", "Remittance", "Peru", "Remittance_nombre_cliente.xlsx"), # Completar nombre del Remittance (excel) a trabajar
        "fbl5n": os.path.join(root,"Archivos", "Cartera", "FBL5N_nombre_cliente.xlsx"), # Completar nombre de la cartera (excel) a trabajar
        "salida": os.path.join(root,"Archivos", "Template", "Peru", "Template_HRC_nombre_cliente.xlsx") # Colocar el nombre de salida que deseen (Ej: Template_HRC_nombre_cliente.xlsx)
    }
