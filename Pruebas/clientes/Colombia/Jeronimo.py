...
def procesar():
    ...
    rutas = {
        "remittance": os.path.join(root,"Archivos", "Remittance", "Colombia", "Remittance_Jeronimo.pdf"), # Completar nombre del Remittance (excel) a trabajar
        "fbl5n": os.path.join(root,"Archivos", "Cartera", "FBL5N_Jeronimo.xlsx"), # Completar nombre de la cartera (excel) a trabajar
        "salida": os.path.join(root,"Archivos", "Template", "Colombia", "Template_HRC_Jeronimo.xlsx") # Colocar el nombre de salida que deseen (Ej: Template_HRC_nombre_cliente.xlsx)
    }
