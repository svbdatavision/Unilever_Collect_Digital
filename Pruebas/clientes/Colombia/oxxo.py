...
def procesar():
    ...
    root = _project_root()
    rutas = {
        "remittance": os.path.join(root, "Archivos", "Remittance", "Colombia", "Remittance_Oxxo.xlsx"),
        "fbl5n": os.path.join(root, "Archivos", "Cartera", "FBL5N_OXXO.xlsx"),
        "salida": os.path.join(root, "Archivos", "Template", "Ecuador")
    }
